...
export const TRACKS: Track[] = [
  {
    ...
    color: 'primary',
    checklist: [
      'العروض التقديمية التفاعلية المتقدمة',
      'السيرة الذاتية الاحترافية (ATS Friendly)',
      'التقارير السنوية والبصرية (Infographics)',
      'تنسيق المستندات الرسمية والخطابات',
      'بطاقات العمل مع رموز QR الذكية',
      'جداول العمل وخطط المشاريع الجمالية',
      'المطبوعات المكتبية والبروشورات',
      'السبورة البيضاء للعصف الذهني الجماعي',
      'شهادات الشكر والتقدير الاحترافية'
    ]
  },
  {
    id: 2,
    ...
    color: 'secondary',
    checklist: [
      'تصميم وبيع القوالب (Templates)',
      'المفكرات والكتب الإلكترونية وأغلفتها',
      'تصميمات الطباعة عند الطلب (POD)',
      'إدارة السوشيال ميديا وحزم البوستات',
      'تصميم الشعارات والهوية البصرية الناشئة',
      'الدعوات والمناسبات الإلكترونية والمطبوعة',
      'أوراق العمل التعليمية الجاهزة للبيع',
      'قوائم الطعام (Menus) العصرية',
      'إعلانات المنتجات لزيادة المبيعات',
      'بناء ملف الإنجاز (Portfolio) المقنع'
    ]
  },
  {
    id: 3,
    ...
    result: 'حضور رقمي طاغٍ ومؤثر',
    icon: 'stars',
    color: 'green-500',
    checklist: [
      'هوية حسابات التواصل الموحدة',
      'تصميم الـ (Thumbnails) لليوتيوب',
      'صناعة ومونتاج الـ (Reels & TikToks)',
      'القصص التفاعلية (Stories) الجذابة',
      'البوستات التعليمية المتسلسلة (Carousels)',
      'أغلفة الحسابات (Banners) الاحترافية',
      'قوالب الاقتباسات والمقولات الملهمة',
      'تعديل واحتراف الصور الشخصية',
      'الإعلانات الشخصية للدورات والورش',
